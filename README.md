...
[![VS Code Marketplace](https://img.shields.io/visual-studio-marketplace/v/promptsonar.promptsonar?label=Marketplace)](https://marketplace.visualstudio.com/items?itemName=promptsonar.promptsonar)
