...
Generated: 2026-05-27T00:45:13.852Z
...
| `unsafe-broad-write.json` | `MCP-008` | `MCP-008` | 2 | PASS |
| `unsafe-hardcoded-secret.json` | `MCP-005` | `MCP-005` | 2 | PASS |
| `unsafe-host-env.json` | `MCP-009` | `MCP-009` | 2 | PASS |
...
| `unsafe-unpinned-package.json` | `MCP-010` | `MCP-010` | 1 | PASS |
