...
const ROLE_EXPECTED_CAPABILITIES: Record<ArtifactKind, ReadonlySet<CapabilityType>> = {
    ...
    claude: new Set<CapabilityType>(['shell', 'filesystem.read', 'filesystem.write', 'network', 'secret.read', 'external_api', 'privileged_tool']),
    agents: new Set<CapabilityType>(['shell', 'filesystem.read', 'filesystem.write', 'network', 'secret.read', 'external_api', 'privileged_tool']),
    skill: new Set<CapabilityType>(['shell', 'filesystem.read', 'filesystem.write', 'network', 'secret.read', 'external_api', 'deployment']),
    mcp: new Set<CapabilityType>(['filesystem.read', 'filesystem.write', 'network', 'external_api', 'secret.read', 'privileged_tool']),
    ...
    deployment_config: new Set<CapabilityType>(['deployment', 'secret.read', 'external_api']),
    ...
    router: new Set<CapabilityType>(['shell', 'filesystem.read', 'filesystem.write', 'network', 'external_api', 'privileged_tool']),
