...
import { PromptSbom, PromptComponent } from './schema';
 ...
 */
export function generatePromptSBOM(results: ScanResultInput[], projectName: string = "promptsonar-scan"): string {
